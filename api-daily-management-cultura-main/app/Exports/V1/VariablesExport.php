...
class VariablesExport implements FromCollection, WithHeadings, WithColumnWidths, WithEvents, ShouldAutoSize
{
    use Exportable;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function (AfterSheet $event) {
                ...
                $event->sheet->getStyle('A:BO')->getAlignment()->setHorizontal('center');
                $event->sheet->setAutoFilter('A:BO');
            },
        ];
    }
