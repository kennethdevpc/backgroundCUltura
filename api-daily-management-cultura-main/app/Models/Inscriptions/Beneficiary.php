...
class Beneficiary extends Model
{
    ...
    {
        return $this->belongsToMany(Binnacle::class);
    }
    public function binnaclesCulturalSeedbed()
    {
        return $this->belongsToMany(CulturalSeedbed::class);
    }
    ...
    {
        return $this->belongsTo(Inscription::class, 'id', 'beneficiary_id');
    }

    public function groupBeneficiaries()
    {
        return $this->belongsTo(Group::class,'id');
    }

    public function methodologicalSheetsTwo()
    {
        return $this->belongsTo(MethodologicalSheetsTwo::class, 'm_s_two_id', 'id');
    }
