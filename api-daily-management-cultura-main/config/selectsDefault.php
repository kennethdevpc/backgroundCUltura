...
return [
    ...
    'activity_type' => [
        0 => [
            'label' => 'Circulación', 'value' => 'C'
        ],
        1 => [
            'label' => 'Ensamble', 'value' => 'E'
        ],
        2 => [
            'label' => 'Semillero cultural', 'value' => 'SC'
        ]
    ...
    'strengthening_types' => [
        0 => [
            'label' => 'Fortalecimiento pedagógico al equipo de apoyo metodológico', 'value' => 'FPAM'
        ],
        1 => [
            'label' => 'Instrucción metodológica, fortalecimiento a gestores', 'value' => 'IMFG'
        ],
        2 => [
            'label' => 'Fortalecimiento especificado a roles', 'value' => 'FEAR'
        ],
        3 => [
            'label' => 'Socialización de la estrategia a otros equipos (cambios metodología, pedagogía, roles, nuevas tendencias)', 'value' => 'SEOE'
        ]
    ],

    'aspects' => [
        0 => [
            'label' => 'Plan de trabajo de gestores enviado previamente', 'value' => 'PTGEP'
        ],
        1 => [
            'label' => 'Solicitudes de direccion,subdireccion,coordinaciones,lideres', 'value' => 'SDSCL'
        ],
        2 => [
            'label' => 'Reportes de plataforma (-/+)', 'value' => 'RP'
        ],
        3 => [
            'label' => 'Autonomía del apoyo pedagogico', 'value' => 'AAP'
        ]
    ],

    'evaluate_aspects' => [
        0 => [
            'label' => 'Proyección artística', 'value' => 'PA'
        ],
        1 => [
            'label' => 'Técnica', 'value' => 'T'
        ],
        2 => [
            'label' => 'Comportamiento', 'value' => 'C'
        ],
    ]
];
