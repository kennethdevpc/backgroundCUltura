...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('profiles', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('supervision_coordinator_id')->nullable();
            $table->foreign('supervision_coordinator_id')
                ->references('id')
                ->on('users')
                ->onDelete('cascade');


            $table->unsignedBigInteger('psychosocial_coordinator_id')->nullable();
            $table->foreign('psychosocial_coordinator_id')
                ->references('id')
                ->on('users')
                ->onDelete('cascade');


            $table->unsignedBigInteger('methodological_coordinator_id')->nullable();
            $table->foreign('methodological_coordinator_id')
                ->references('id')
                ->on('users')
                ->onDelete('cascade');


            $table->unsignedBigInteger('administrative_coordinator_id')->nullable();
            $table->foreign('administrative_coordinator_id')
                ->references('id')
                ->on('users')
                ->onDelete('cascade');
            ...
            $table->unsignedBigInteger('sub_direccion_id')->nullable();
            $table->foreign('sub_direccion_id')
                ->references('id')
                ->on('users')
                ->onDelete('cascade');
