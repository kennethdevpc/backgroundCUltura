...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cultural_seedbeds', function (Blueprint $table) {
            $table->id();
            $table->date('date');
            ...
            $table->text('level_domain_description', 3500);
            $table->string('objective_process', 3500);
            ...
            $table->string('observations', 3500);
    ...
    {
        Schema::dropIfExists('cultural_seedbeds');
    }
};
