...
class ModuleItemSeeder extends Seeder
{
    ...
    protected $monitors = [
        ...
        ['Bitácora show cultural', 'binnacleculturalshow.index', 'MinusIcon'],
    ];

    protected $inscructors = [
        ['Ficha metodológica de planeación', 'methodologicalsheetsone.index', 'MinusIcon'],
        ['Ficha metodológica de evaluación', 'methodologicalsheetstwo.index', 'MinusIcon'],
        ['Bitácora ensamble cultural', 'culturalEnsembles.index', 'MinusIcon'],
    ...
    protected $coordinador_seguimiento = [
        ...
        //['Cultural seed bed prueba', 'culturalSeedbeds.index', 'MinusIcon'],
    ];

    protected $direccion = [
        ['Informe supervisión', 'reportSupervision.index', 'MinusIcon'],
    ];


    // ['Show cultural', 'binnacleculturalshow', 1, 'UsersIcon'], //SHOW CULTURAL
