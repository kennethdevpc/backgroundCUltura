...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->setPermissions('alerts', 'Alertas');
        ...
        $this->setPermissions('binnacleculturalshow', 'Show cultural'); //SHOW CULTURAL
        ...
        $this->setPermissions('methodologicalsheetstwo', 'Ficha Metodológica de evaluación');


        DB::table('permissions')->insert([
            'name' => 'Bitacora vista de territorio de coordinadores director',
            'slug' => 'reportTerritoryCoordinators.index',
            'description' => 'Bitacora vista de territorio de coordinadores para director',
            'controller' => 'none'
        ]);

        //NO PONER NADA DEBAJO DE ESTO.
        DB::table('permissions')->insert([
            'name' => 'Configuración',
            'slug' => 'setting',
        ...
        DB::table('permissions')->insert([
            'name' => 'Actividad de la plataforma',
            'slug' => 'activityLogs',
            'description' => 'User can show Actividad de la plataforma',
            'controller' => 'none'
        ]); //144
        // Aca para el super admin y no alterar otras cosas
        $this->setPermissions('activityLogs', 'Actividad de la plataforma');
    }
