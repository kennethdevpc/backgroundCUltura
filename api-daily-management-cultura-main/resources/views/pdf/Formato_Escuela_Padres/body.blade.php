        ...
        <tr>
            <table width="100%" style="">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="9" rowspan="2">
                            <p style="text-align: left;margin-top: -1%;margin-bottom:0%">
                                <b>1.5 Lugar De Atención:</b>
                            </p>
                        </td>
                        <td colspan="8" rowspan="2">
                            <p style="text-align: left;margin-top: -1%;margin-bottom:0%">
                                {{ $data->place_attention }}
                            </p>
                        </td>
                        <td colspan="9" rowspan="2">
                            <p style="text-align: left;margin-top: -1%;margin-bottom:0%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="17" rowspan="2">
                            <p style="text-align: left;margin-top: -1%;margin-bottom:0%">
                                <b>3.1 Foto que evidencia el desarrollo</b>
                            </p>
                        </td>
                        <td colspan="17" rowspan="2">
                            <p style="text-align: left;margin-top: -1%;margin-bottom:0%">
                                <b>3.2 Foto que evidencie la participación de los asistentes</b>
                            </p>
                        </td>
                    </tr>
                    <tr></tr>
            ...
            <table width="100%" style="">
                ...
                <tbody>
                    ...
                    @foreach ($data->addedWizards as $key => $addedWizards)
                        <tr></tr>
                        <tr>
                            <td colspan="4" rowspan="2">
                                <p style="text-align: center;margin-top: -1%;margin-bottom:0%">
                            ...
                            <td colspan="6" rowspan="2">
                                <p style="text-align: center;margin-top: -1%;margin-bottom:0%">
                                    {{ $addedWizards->assistant->assistant_name }}
                                </p>
                            </td>
                            <td colspan="6" rowspan="2">
                                <p style="text-align: center;margin-top: -1%;margin-bottom:0%">
                            ...
                            <td colspan="6" rowspan="2">
                                <p style="text-align: center;margin-top: -1%;margin-bottom:0%">
                                    {{ $addedWizards->assistant->assistant_email }}
                                </p>
                            </td>
                        </tr>
                    @endforeach
