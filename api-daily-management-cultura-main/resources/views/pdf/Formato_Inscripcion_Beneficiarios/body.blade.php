                ...
                <table width="100%" style="">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="17" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    {{ $data->benefiary->userbeneficiario->name }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        <tr>
                            ...
                            <td colspan="17" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    {{ $data->benefiary->participant_type=='C'?'Caracterizado':'NoCaracterizado' }}
                                </p>
                            </td>
                        </tr>
                    </tbody>
                        ...
                        <tr>
                            <td colspan="6" rowspan="10">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    <center>
                                        @php
                                            if ($data->benefiary->file != null) {
                                                $im2 = imagecreatefromwebp(storage_path().'/app/public/'.$data->benefiary->file);
                                                imagejpeg($im2, storage_path().'/app/public/'.substr($data->benefiary->file,-5).'.jpeg', 100);
                                            }
                                        @endphp
                                        @if ($data->benefiary->file != null)
                                            <img style="width:100%;height: 115px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(storage_path().'/app/public/'.substr($data->benefiary->file,-5).'.jpeg'))}}">
                                        @endif
                            ...
                            <td colspan="18" rowspan="2">
                                <p style="text-align: justify;margin-top: 0%;margin-bottom:0%">
                                    <b>1.1 Fecha:</b> {{ $data->benefiary->created_at }}
                                </p>
                            </td>
                        ...
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    ...
                                    <b>2.1 Nombres y Apellidos:</b> {{ $data->benefiary->full_name }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        ...
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    @php
                                        $relationship = '';
                                        switch ($data->benefiary->attendant?->relationship) {
                                            case 'P':
                                                $relationship = 'Papá';
                                                break;
                                            case 'M':
                                    ...
                                    @endphp
                                    <b>1.1 Parentesco con el beneficiario:</b> {{ $relationship }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    ...
                                    <b>1.2 Nombres y Apellidos:</b> {{ $data->benefiary->attendant?->full_name }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                ...
                <table width="100%" style="">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="24" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    @php
                                        $genders = '';
                                        switch ($data->benefiary->attendant?->socio_demo?->gender) {
                                            case 'M':
                                                $genders = 'Masculino';
                                                break;
                                            case 'F':
                                    ...
                                    @endphp
                                    <b>2.1 Genero:</b> {{ $genders }}
                                </p>
                            </td>
                            <td colspan="10" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    <b>2.2 Edad:</b>
                                    {{ $data->benefiary->attendant?->socio_demo?->age }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    ...
                                    {{ $data->benefiary->attendant?->socio_demo?->decision_study==1 ? 'Si' : 'No' }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    @php
                                        $educational_level = '';
                                        switch ($data->benefiary->attendant?->socio_demo?->educational_level) {
                                            case 'PREE':
                                                $educational_level = 'Preescolar';
                                                break;
                                            case 'PRI':
                                    ...
                                    @endphp
                                    <b>2.4 Nivel educativo alcanzado:</b> {{ $educational_level }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    <b>2.5 ¿Presenta discapacidad?:</b> {{ $data->benefiary->attendant?->socio_demo?->decision_study==1?'Si':'No' }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    @php
                                        $disability_types = '';
                                        switch ($data->benefiary->attendant?->socio_demo?->disability_type) {
                                            case 'F':
                                                $disability_types = 'Física';
                                                break;
                                            case 'V':
                ...
                <table width="100%" style="">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    <b>3.1 ¿A qué regimen de salud colombiano pertenece?:</b> {{ $data->benefiary->attendant?->health_data?->medical_service=='C'?'Contributivo':'Subsidiado' }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    <b>3.2 Nombre de la EPS:</b> {{ $data->benefiary->attendant?->health_data?->entity_name->name }}
                                </p>
                            </td>
                        </tr>
                        <tr></tr>
                        <tr>
                            <td colspan="34" rowspan="2">
                                <p style="text-align: left;margin-top: 0%;margin-bottom:0%">
                                    @php
                                        $health_condition = '';
                                        switch ($data->benefiary->attendant?->health_data?->health_condition) {
                                            case 'B':
                                                $health_condition = 'BUENA';
                                                break;
                                            case 'R':
                                    ...
                                    @endphp
                                    <b>3.3 Estado de salud del acudiente:</b> {{ $health_condition }}
                                </p>
                            </td>
                        </tr>
                    </tbody>
