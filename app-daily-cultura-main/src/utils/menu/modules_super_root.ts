...
const modules_super_root: module[] = [
	{
		name: "Configuración",
		icon: "SettingsIcon",
		items: [
			...
			{
				name: "Control de cambios en data",
				route: "changeDataModels.index",
				icon: "accessibilityIcon",
			},
			{
	...
	},
	{
		...
		items: [
			...
			{
				name: "Derechos culturales",
				route: "cultural-rights.index",
				icon: "MinusIcon",
			},
			{
				name: "Entidades",
	...
	},
	{
		...
		items: [
			{
				name: "Fortalecimiento a la supervisión de Monitores e Instructores",
				route: "strengtheningSuperMonIns.index",
				icon: "MinusIcon",
			},
			{
				name: "Fortalecimiento a la supervisión de gestores",
	...
	{
		name: "B. Territorio - Inf. Supervisión",
		icon: "UsersIcon",
		items: [
			{
...
export default modules_super_root;
