...
<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Informe de seguimiento</h2>
    <div
      v-if="permissions.monitoringReports.create()"
  ...
  <div class="intro-y box mt-5 p-5">
    ...
    <BaseCrud
      ...
      :management_permissions="permissions.monitoringReports.crud_management()"
      label="el informe"
